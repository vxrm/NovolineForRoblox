...
local files = {'chosenui.txt', 'games/Bedwars.lua', 'games/BedFight.lua', 'games/Universal.lua', 'guis/autumnv1.lua', 'guis/moon3.lua', 'libraries/Animations.lua', 'libraries/Entity.lua', 'libraries/Blur.lua'}
